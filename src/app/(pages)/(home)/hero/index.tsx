...
const Hero: React.FC = () => {
    useEffect(() => {
        gsap.fromTo('.title span',
            ...
            { y: 0, opacity: 1, rotate: 0, duration: 1.2, ease: 'power4.out', stagger: 0.2 }
        );
        gsap.fromTo('.subdescription',
            { y: 50, opacity: 0 },
    ...
    return (
        <section className={classes.hero}>
            <div className={classes.hero__content}>
                ...
                <p className={`${classes.hero__description} description`}>It's time to build a new world, to unite meme tokens, communities and projects.</p>
